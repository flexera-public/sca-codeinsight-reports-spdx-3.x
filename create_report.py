...
Note:
  ...
  - The -reportOpts flag is optional. If omitted, all values will default to "includeChildProjects":"True".
...
def main():
	...
	if args.reportOptions is not None:
		...
		reportOptions = '{"includeChildProjects":"True", "creatorName":"OrganizationName"}'
		if sys.platform.startswith("linux"):
			reportOptions = '{"includeChildProjects":"True", "creatorName":"OrganizationName"}'
	...
	reportData["authToken"] = authToken
